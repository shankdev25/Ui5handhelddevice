        ...
        onEditItem: function(oEvent) {
            ...
            var oDialog = new sap.m.Dialog({
                ...
                content: [
                    ...
                    new sap.m.Input({ value: oData.issuingStorageLocation, liveChange: function(e){ oData.issuingStorageLocation = e.getParameter("value"); } }),
                    new sap.m.Label({ text: "Internal Order" }),
                    new sap.m.Input({ value: oData.internalOrder, liveChange: function(e){ oData.internalOrder = e.getParameter("value"); } }),
                    new sap.m.Label({ text: "Cost Center" }),
                    new sap.m.Input({ value: oData.costCenter, liveChange: function(e){ oData.costCenter = e.getParameter("value"); } }),
